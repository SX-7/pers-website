...
if bool(os.environ.get("DEVELOPMENT_ENV", False)):
    ...
    file_prefix = "app/"
with open(file_prefix + "templates/data/projects/index.yaml", "r", encoding="utf-8") as file:
    project_file_data = yaml.safe_load(file)
with open(file_prefix + "static/links/index.yaml", "r", encoding="utf-8") as file:
...
def projects():
    ...
    return render_template(
        "projects.html", page=current_page, id=2, projects=project_file_data
    )
